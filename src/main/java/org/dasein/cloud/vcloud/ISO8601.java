...
/**
 * This class is from Apache Jackrabbit Commons. It has been imported
 * wholesale but modified to also support (legal) timestamp forms that
 * don't specify milliseconds.
 *
